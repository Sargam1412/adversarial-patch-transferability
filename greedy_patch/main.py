...
def save_results(patch1, patch2, patch3, patch4, iou_metrics, save_dir, patch_ext='pt'):
    """
    ...
    torch.save(patch1, os.path.join(save_dir, f'optimized_patch1.{patch_ext}'))
    torch.save(patch2, os.path.join(save_dir, f'optimized_patch2.{patch_ext}'))
    torch.save(patch3, os.path.join(save_dir, f'optimized_patch3.{patch_ext}'))
    torch.save(patch4, os.path.join(save_dir, f'optimized_patch4.{patch_ext}'))
...
def main():
    ...
    save_results(patch1, patch2, patch3, patch4, iou_metrics, args.output_dir, args.patch_ext)
